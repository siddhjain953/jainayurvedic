                ...
                <div style="text-align: left;">
                    ...
                    <div style="margin-bottom: 15px;">
                        ...
                        <div style="background: #fdf2f7; padding: 8px; border: 1px solid #f8bbd0; border-radius: 4px; font-family: monospace; word-break: break-all;">
                            <a href="${data.url}/customer.html" target="_blank" style="text-decoration:none; color:#c2185b;">${data.url}/customer.html</a>
                        </div>
                    </div>
                    ...
                    <div style="margin-bottom: 15px;">
                        ...
                        <div style="background: #e3f2fd; padding: 8px; border: 1px solid #bbdefb; border-radius: 4px; font-family: monospace; word-break: break-all;">
                            <a href="${data.url}/retailer.html" target="_blank" style="text-decoration:none; color:#1565c0;">${data.url}/retailer.html</a>
                        </div>
                    </div>
    ...
    try {
        ...
        if (data.active && data.url) {
            ...
            if (linkDisplay.innerText !== data.url) {
                linkDisplay.innerHTML = `<a href="${data.url}/retailer.html" target="_blank" style="text-decoration:none; color:#1565c0;">${data.url}</a>`;
            }
