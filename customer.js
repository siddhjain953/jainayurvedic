...
class CustomerApp {
    ...
    init() {
        ...
        // IMMEDIATE RENDER - NO WHITE SCREEN
        this.render();
    }
            ...
            <div class="login-wrapper">
                <div class="login-card">
                    <div class="login-header">
                        ...
                        <h1>Welcome to <span class="highlight">Kirana Shop</span></h1>
                        <p>A premium digital bazaar at your fingertips.</p>
                    </div>
                    ...
                    <form id="loginForm" class="login-form">
                        ...
                        <div class="form-group">
                            ...
                            <input type="tel" id="customerMobile" placeholder="10-digit mobile" required pattern="[6-9][0-9]{9}" maxlength="10">
                            <span class="form-note">* For loyalty points and order history</span>
                        </div>
                    ...
                    <div class="login-footer">
                        <p>🛡️ Private & Secured Connection</p>
                    </div>
                </div>
            </div>
        `;
    ...
    async loadStaticMenu() {
        ...
        checkoutViaWhatsApp(request) {
            const phone = "919876543210"; // Placeholder - retailer number
